...
if ($row['radminsuper'] == 1) {
	...
	<input type='radio' name='xanonpost' value='0' checked>" . _NO . "";
		...
		."<table border='0'><tr><td>"
		."" . _FOOTERLINE1 . ":</td><td><textarea name='xfoot1' cols='100%' rows='15' width='100%'>" . stripslashes($foot1) . "</textarea>"
		."</td></tr><tr><td>"
		."" . _FOOTERLINE2 . ":</td><td><textarea name='xfoot2' cols='100%' rows='15' width='100%'>" . stripslashes($foot2) . "</textarea>"
		."</td></tr><tr><td>"
		."" . _FOOTERLINE3 . ":</td><td><textarea name='xfoot3' cols='100%' rows='15' width='100%'>" . stripslashes($foot3) . "</textarea>"
		."</td></tr></table>";
		CloseTable();
		echo "<br>";
		OpenTable();
	...
	<input type='radio' name='xnotify' value='0' checked>" . _NO . "";
		...
		."</td></tr><tr><td>"
		."" . _EMAILMSG . ":</td><td><textarea name='xnotify_message' cols='100%' rows='15'  width='100%'>$notify_message</textarea>"
		."</td></tr><tr><td>"
