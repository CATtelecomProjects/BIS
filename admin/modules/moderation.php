...
if ($row['radminsuper'] == 1) {
	...
	function moderation_news() {
		...
		if ($a != 1) {
			echo "<td bgcolor=\"$bgcolor1\" colspan=\"3\" align=\"center\">&nbsp;"._NOCONTENT."&nbsp;</td></tr>";
		}
		echo "</table>";
		CloseTable();
		include("footer.php");
	...
	function moderation_surveys_view($id) {
		...
		OpenTable2();
		echo "<center>".$poll['pollTitle']."</center>";
		CloseTable2();
		if (!empty($reply)) {
			echo "<br><br><center><b>"._INREPLYTO."</b></center><br>";
			OpenTable2();
	...
	function moderation_users_list($section=0) {
		...
		if ($a != 1) {
			echo "<tr><td bgcolor=\"$bgcolor1\" colspan=\"2\" align=\"center\">&nbsp;"._NOCONTENT."&nbsp;</td></tr>";
		}
		echo "</table><br><br>";
		$a = 0;
