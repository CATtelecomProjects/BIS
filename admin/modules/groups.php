...
if ($row['radminsuper'] == 1) {
	...
	function Groups() {
		...
		."<tr><td>" . _POINTSNEEDED . ":</td><td><input type=\"text\" name=\"points\" size=\"10\" maxlength=\"20\" value=\"0\">&nbsp;(" . _ONLYNUMVAL . ")</td></tr>"
		."</table><br><br>"
	...
	function grp_edit($id) {
		...
		."<tr><td>" . _POINTSNEEDED . ":</td><td><input type=\"text\" name=\"points\" size=\"10\" maxlength=\"20\" value=\"$points\">&nbsp;(" . _ONLYNUMVAL . ")</td></tr>"
		."</table><br><br>"
