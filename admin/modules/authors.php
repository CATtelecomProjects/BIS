...
if (($row['radminsuper'] == 1) && ($row['name'] == 'God')) {
	...
	function displayadmins() {
		...
		while ($row = $db->sql_fetchrow($result)) {
			...
			if ($name == "God") {
				echo "<tr><td>&nbsp;$a_aid ("._MAINACCOUNT.")&nbsp;</td>";
			} else {
				echo "<tr><td>&nbsp;$a_aid&nbsp;</td>";
			}
		...
		."</tr>"
		."<tr><td>&nbsp;</td><td colspan=\"3\"><font class=\"tiny\">" . _SUPERWARNING . "</font></td></tr>"
		."<tr><td>" . _PASSWORD . "</td>"
	...
	if (is_admin($admin)) {
		...
		."</tr><tr><td>&nbsp;</td>"
		."<td colspan=\"3\"><font class=\"tiny\">" . _SUPERWARNING . "</font></td></tr>"
		."<tr><td>" . _PASSWORD . ":</td>"
	...
	switch ($op) {
		...
		if ($add_radminsuper == "") { $add_radminsuper = 0; }
		$sql = "insert into " . $prefix . "_authors values ('$add_aid', '$add_name', '$add_url', '$add_email', '$add_pwd', '0', $add_radminsuper, '$add_admlanguage')";
