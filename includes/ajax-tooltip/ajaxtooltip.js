...
var ajaxtooltip={
	fadeeffect: [true, 0], //enable Fade? [true/false, duration_milliseconds]
	useroffset: [10, 10], //additional x and y offset of tooltip from mouse cursor, respectively
	//loadingHTML: "<div name='loading' style='font-family:tahoma;font-size=9pt;font-weight:normal;color:green'><img src='../../images/loading.gif' align='absmiddle' /> °”≈—ß‚À≈¥...</div>",
