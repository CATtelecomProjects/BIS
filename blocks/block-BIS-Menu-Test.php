...
function eis()
{
	...
	for (i=0;i<=(main.p.value.length-1);i++)
	{
		...
		{
			ch = 1;
			//alert('กำลังอยู่ในช่วงปรับปรุงระบบ!!');			
...
function dw_DWPortal()
{
	...
	for (i=0;i<=(main.p.value.length-1);i++)
	{
		...
		{
			ch = 1;
			fullscreen('CntUsr.php?select=P');
			SaveEvent('sysname=DW/DM Web Portal&denied=1','divLoadEventPortal');			
			//openPopUp('WebPortal','CntUsr.php?select=P','SAS Information Delivery Portal'); return false;
			//SaveEvent('sysname=DW/DM Web Portal&denied=1','divLoadEventPortal');
...
function dw_WebStudio()
{
	...
	for (i=0;i<=(main.p.value.length-1);i++)
	{
		...
		{
			ch = 1;		
			fullscreen('CntUsr.php?select=R');SaveEvent('sysname=DW/DM Web Report Studio&denied=1','divLoadEventReport');		
...
<!-------- ข่าวประกาศ --------->
<!--<body onLoad="displayMessage('./notification.php','320','150');"></body> -->
...
$content  .= "    <br>&nbsp;<input type=\"button\" value=\"ออกจากระบบ\" style=\"cursor:pointer\"  title=\"ออกจากระบบ\" onclick=\"displayMessage('./modules/Login/dialog_Logout.php','320','140');return false;\">";
$content  .= "       </td>";
$content  .= "      </tr>";
...
$content  .= "          <td width=\"95%\" valign=\"top\"><span class=\"textHead\"><img src=\"images/indent1.png\" border=\"0\" >";
$content  .= "          <a href=\"CntUsr.php?select=P&Auth=".base64_encode($_SESSION['p'])."\" target=\"_blank\">";
$content  .= "          <u>BI Report</u> : </span> <br />";
...
$content  .= "    <tr>";
$content  .= "    <td height=\"20\" align=\"left\" valign=\"top\"  style=\"padding:2px 0px 2px 0px; border-bottom:1px dotted #C0C0C0;cursor:pointer\" onmouseover=\"style.backgroundColor='#CCFFCC';\" onmouseout=\"style.backgroundColor='';\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
$content  .= "        <tr onclick=\"fullscreen('http://infodept.cattelecom.com/dcss');SaveEvent('sysname=DCSS&denied=1','divLoadEventDCSS');\">";
...
//$content .= "<span id=\"divDcss\">&nbsp;<font color='red'><img src=\"./images/indent1.png\" align=\"absmiddle\"> <b>รายงานระบบสารสนเทศบริการสื่อสารข้อมูลและเครือข่าย</b></font></span>";	
	...
	$content  .= "<font color='#FF0000'><b>เข้าสู่ระบบสารสนเทศทางธุรกิจ<br><br><input type=\"button\" value=\" กรุณาคลิกที่นี่ \" title=\"คลิกที่นี่เพื่อเข้าสู่ระบบ\" onclick=\"displayMessage('./modules/Login/dialog_Login.php','470','285');return false\" style=\"cursor:pointer\"></b><br>&nbsp;<br>&nbsp;</font></center>";
}
?>
