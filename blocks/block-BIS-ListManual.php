...
$content  .= "<td align=\"left\"  valign=\"top\"><br><p style='color:red'>&nbsp;<strong>ระบบรายงาน DW/DM แนะนำให้ใช้งานเว็บเบราเซอร์ IE <br>ซึ่งจะสามารถใช้งานได้ทุกฟีเจอร์การใช้งาน!!</strong></p>
 <a href='http://dw-webreport.cattelecom.com/dwdm-faq/manual.html' target='_Blink'><h3><img src='http://dw-webreport.cattelecom.com/dwdm-faq/images/manual_icon.png' border='0' align='absmiddle'> [คลิ๊กที่นี่] </h3></a>
 <br><a href='http://dw-webreport.cattelecom.com/dwdm-faq/downloads/manual/DWDM-Keyword_final.pdf' target='_Blink'><img src='https://bis.cattelecom.com/images/pdf.gif' border='0' align='absmiddle' width='15' height='15'> ความหมายคำศัพท์ในระบบ DW/DM</a>
<br><a href='http://dw-webreport.cattelecom.com/dwdm-faq/downloads/manual/DWDM_shared_Mas_Trans.pdf' target='_Blink'><img src='https://bis.cattelecom.com/images/pdf.gif' border='0' align='absmiddle' width='15' height='15'> รายการข้อมูลที่ใช้ร่วมกันในระบบ DW/DM</a>
<br><a href='http://dw-webreport.cattelecom.com/dwdm-faq/downloads/manual/DWDM_Master_all_module.pdf' target='_Blink'><img src='https://bis.cattelecom.com/images/pdf.gif' border='0' align='absmiddle' width='15' height='15'> รายการข้อมูล Master ในระบบ DW/DM </a>";


// แสดงปุ่มค้นหารายงาน
if(isset($_SESSION['userid'])){
$content  .= "<br>&nbsp;";
$content  .= "<form action=\"http://dw-webreport.cattelecom.com/dwdm-management/signin_ext.php\" method=\"post\" target=\"_blank\">";
$content  .= "<button type='submit'><span style='font-size:medium'>ค้นหารายงาน DW/DM</span></button>";
//$content  .= "<button class=\"ui-button ui-widget ui-corner-all\">";
//$content  .= "    <span class=\"ui-icon ui-icon-search\"></span> ค้นหารายชื่อรายงาน DW/DM";
//$content  .= "  </button>";
$content  .= "<input name=\"redirect\" type=\"hidden\" value=\"setModule%3DSM%26setPage%3Ddwdm_sm_search_report\">";
$content  .= "<input name=\"userid\"  type=\"hidden\" value=\"".$_SESSION[userid]."\">";
$content  .= "<input name=\"password\"  type=\"hidden\" value=\"".$_SESSION[password]."\">";
$content  .= "<input name=\"desc\"  type=\"hidden\" value=\"".$_SESSION[desc]."\">";
$content  .= "</form>";
} 


// แสดงปุ่มค้นหารายงาน
if($_SESSION['userid'] == '00206134' || $_SESSION['userid'] == '00348364' || $_SESSION['userid'] == '00354293' || $_SESSION['userid'] == '00336101' ){
$content  .= "<a class='ui-button ui-widget ui-corner-all ui-' id='linkQuestionare' href='dwdm_questionnaire.php'><span style='font-size:medium;font:#blue'>แบบสอบถาม การเข้าดูรายงานระบบ DW/DM</span></a>";
} 
...
//$content  .= " <td width=\"15%\" rowspan=\"4\" align=\"center\" valign=\"top\">&nbsp;</td>";
//$content  .= " <td align=\"left\" valign=\"top\"  style=\"padding:2px 0px 2px 0px; border-right:1px dotted #C0C0C0\">&nbsp;</td>";
$content  .= " <td colspan=\"2\" align=\"left\" valign=\"top\"><strong><img src=\"./images/arrowT.gif\" width=\"11\" height=\"9\" /> ดาวน์โหลดคู่มือการใช้งาน ระบบ EBM</strong></td>";
$content  .= " </tr>";
$content  .= "<tr>";
//$content  .= " <td align=\"left\" valign=\"top\"  style=\"padding:2px 0px 2px 0px; border-right:1px dotted #C0C0C0\">&nbsp;</td>";
$content  .= "<td align=\"center\" valign=\"top\"><img  src=\"images/ebm-logo.gif\"  align=\"middle\" border=\"0\" /></td>";
$content  .= "<td align=\"left\"  valign=\"top\"><img src=\"./images/usermanual.gif\"  align=\"absmiddle\" /> <a href=\"/usermanual/ebm/EBM_UserManual_V.1.1_20160726v96.pdf\" target=\"blank\">ดาวน์โหลดคู่มือการใช้งานระบบ (pdf)</a> <br>";
//$content  .= "<img src=\"./images/usermanual.gif\" title=\"Download\"  border=\"0\" align=\"absmiddle\"/> <a href=\"../bsc-kpi/Usermanual/KPI_Manual_for_User.zip\">ดาวน์โหลดคู่มือการใช้งานระบบ (zip)</a><br>";
$content  .= "</td>";
$content  .= "</tr>";
$content  .= "<tr>";
...
<script>
  $( function() {
    ...
    $('button[type=submit]').button({icons: {primary: 'ui-icon-search'}});
    $('#linkQuestionare').button({icons: {primary: 'ui-icon-document'}});
