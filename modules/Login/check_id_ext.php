...
//					return true; // Expire แล้ว					 
	...
	$Auth->port = "110";
	$Auth->username = trim(stripslashes($_GET['emp_code']));
...
$autoForm = " <form id= \"logonForm\" name= \"logonForm\" action=\"http://dw-webreport.cattelecom.com/dwdm-management/modules/SM/dwdm_sm_authen_bis.php\" method=\"post\"> ";
...
$autoForm .= " <input name=\"setModule\" id=\"setModule\" type=\"hidden\" value=\"$setModule\">";	
$autoForm .= " <input name=\"setPage\" id=\"setPage\" type=\"hidden\" value=\"$setPage\">";	
//$autoForm .= " <input name=\"reportURL\" id=\"reportURL\" type=\"hidden\" value=\"".$reportURL."\">";				
