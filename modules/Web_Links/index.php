...
function NewLinks($newlinkshowdays) {
	...
	while ($counter <= 7-1){
		...
		$newlinkView = date("d-m-Y", $newlinkdayRaw);
...
function NewLinksDate($selectdate) {
	...
	$dateView = (date("d-m-Y", $selectdate));
	include("header.php");
	menu(1);
	echo "<br>";
	OpenTable();
...
function outsidelinksetup($lid) {
    ...
    <center>&lt;a href=\"$nukeurl/modules.php?name=$module_name&amp;l_op=ratelink&amp;lid=$lid\"&gt;"._RATETHISSITE."&lt;/a&gt;</center>
    <br><br>
