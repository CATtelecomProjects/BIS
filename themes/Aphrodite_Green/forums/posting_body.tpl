<div class="forumline nav-div">
	<p class="nav-header">
		...
		<!-- BEGIN switch_not_privmsg --> 
			&raquo;  <a href="{U_VIEW_FORUM}">{FORUM_NAME}</a> &raquo; <a href="#" class="nav-current">{L_POST_A}</a>
		<!-- END switch_not_privmsg -->
		<!-- BEGIN switch_privmsg -->
			&raquo; <a href="{U_PRIVATEMSGS}">{L_PRIVATEMSGS}</a> &raquo; <a href="#" class="nav-current">{L_POST_A}</a>
		<!-- END switch_privmsg -->
	</p>
	<div class="nav-links">
...
<tr>
	<td colspan="2" class="row-header"><span>{L_POST_A}</span></td>
</tr>
<!-- BEGIN switch_username_select -->
<tr> 
...
{POLLBOX} 
<tr> 
	<td class="catBottom" colspan="2"> {S_HIDDEN_FORM_FIELDS}<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" />&nbsp;<input type="submit" tabindex="5" name="preview" class="liteoption" value="{L_PREVIEW}" /></td>
</tr>
</table>
