...
<table border="0" cellpadding="0" cellspacing="0" class="tbt"><tr><td class="tbtl"><img src="themes/CAT-CoolStyle/forums/images/spacer.gif" alt="" width="22" height="22" /></td><td class="tbtbot">{L_VIEWING_PROFILE}<img src="themes/CAT-CoolStyle/forums/images/spacer.gif" alt="" width="8" height="22" align="absmiddle" /></td><td class="tbtr"><img src="themes/CAT-CoolStyle/forums/images/spacer.gif" alt="" width="124" height="22" /></td></tr></table>
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  <tr> 
	<td class="cat" width="40%" height="28" align="center"><b><span class="gen">{L_AVATAR}</span></b></td>
	<td class="cat" width="60%"><b><span class="gen">{L_ABOUT_USER}</span></b></td>
  </tr>
  <tr> 
  ...
  <tr> 
	<td class="cat" align="center" height="28"><b><span class="gen">{L_CONTACT} {USERNAME} </span></b></td>
  </tr>
  <tr> 
