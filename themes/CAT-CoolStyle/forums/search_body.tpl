...
<table border="0" cellpadding="0" cellspacing="0" class="tbt"><tr><td class="tbtl"><img src="themes/CAT-CoolStyle/forums/images/spacer.gif" alt="" width="22" height="22" /></td><td class="tbtbot">{L_SEARCH_QUERY}<img src="themes/CAT-CoolStyle/forums/images/spacer.gif" alt="" width="8" height="22" align="absmiddle" /></td><td class="tbtr"><img src="themes/CAT-CoolStyle/forums/images/spacer.gif" alt="" width="124" height="22" /></td></tr></table>
