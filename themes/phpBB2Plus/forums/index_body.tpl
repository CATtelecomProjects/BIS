...
<td class="rowpic" colspan="3"><img src="themes/phpBB2Plus/forums/images/spacer.gif" alt="" width="280" height="12" /></td>
</tr>
<!-- BEGIN forumrow -->
<tr>
...
<tr>
<td class="row1" rowspan="3"><img src="themes/phpBB2Plus/forums/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" width="46" height="25" class="imgfolder" title="{L_WHO_IS_ONLINE}" />
</td>
