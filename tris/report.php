...
// ------------------------------------   END  Dropdown list   เดือน  12 เดือน  --------------------------------------
		...
		// ===  ถ้า ตัวแปรส่งค่า ไม่มีค่า   แสดงว่าเป็นหน้าแรก ยังไม่มีการส่งค่า ตัวแปร  กำหนดค่าให้เป็น "01" ซะ		
		if (!isset($mn))
			{
				$mn = date(n) ;  // เก็บเดือนปัจจุบัน จากวันที่ในระบบ
	 ...
	 //  Hard code ให้แสดง  เดือน 12 ของ ปี 50  ก่อน  เพราะว่า  จะยกเลิกระบบนี้แล้วไปใช้ของ ircp 
				$mn="12"; 
	 //---------
...
//			$sql_yr = " select year from tris_topic where year = '".$yr."' group by year ";
		...
		// นับจำนวน rows ว่ามีกี่ rows  จากการ select ปีปัจจุบัน
												...
												if ($n1 == $headnum1)
													{
																...
																//-- เกณฑ์วัดการดำเนินงาน
																	...
																	if($topic_hot_array[$t1] <>null)
														           {
																		...
																		// echo $topic_change;
                                                                         $chk_file_exists = "document/eva".$topic_change.chkmn($mn).$yr.".pdf";

																										 if (file_exists ($chk_file_exists) )
																											 {
																												//"File already exists. ";
																												echo '<a href="document/eva'.$topic_change.chkmn($mn).$yr.'.pdf" target="_blank" title="คลิ๊กเพื่อดูเอกสารประกอบ"> <img src="images/icon_hot.gif"  border="0" align="top"></a>';  
																											  }
																										 else
																											 {
																...
																//-- ค่าเกณฑ์วัดปีบัญชี ...............
// sql   ค่าเกณฑ์วัดปีบัญชีเดือน ธันวาคม
									                                  $sql_tris_year_criteria12 = " select * from tris_year_criteria where year = '".$yr."' and month = '12' and topic_id = '".$topic_code_array[$t1]."' ";
															
																		// นับจำนวน rows ว่ามีกี่ rows
																		  $cntrows12 = OCIParse($db_conn, $sql_tris_year_criteria12);
																		  OCIExecute($cntrows12);
																		  $chkrows12 = OCIFetchstatement($cntrows12,$results);
																		// นับจำนวน rows ว่ามีข้อมูลหรือไม่
//โหลดข้อมูลเดือนธันวาคม
                                                                  if ($chkrows12 > 0)
																			{   
																				$data_tris_year_criteria12 = ociparse($db_conn,$sql_tris_year_criteria12);
																				ociexecute($data_tris_year_criteria12);

																						while (ocifetch($data_tris_year_criteria12))
																							{
																										
																											if ( $topic_criteria_type_array[$t1] == "2" )
																												{
																													$yr_criteria1_12 = number_format(ociresult($data_tris_year_criteria12,4),2,".",",");
																													$yr_criteria2_12 = number_format(ociresult($data_tris_year_criteria12,5),2,".",",");
																													$yr_criteria3_12= number_format(ociresult($data_tris_year_criteria12,6),2,".",",");
																													$yr_criteria4_12 = number_format(ociresult($data_tris_year_criteria12,7),2,".",",");
																													$yr_criteria5_12 = number_format(ociresult($data_tris_year_criteria12,8),2,".",",");

																												}
																											else  // ที่เหลือ  ใส่ ทศนิยม 2 ตัว
																												{
																														$yr_criteria1_12 = number_format(ociresult($data_tris_year_criteria12,4),0,".",",");
																														$yr_criteria2_12 = number_format(ociresult($data_tris_year_criteria12,5),0,".",",");
																														$yr_criteria3_12 = number_format(ociresult($data_tris_year_criteria12,6),0,".",",");
																														$yr_criteria4_12 = number_format(ociresult($data_tris_year_criteria12,7),0,".",",");
																														$yr_criteria5_12 = number_format(ociresult($data_tris_year_criteria12,8),0,".",",");
																												}
																							}
																			}																	
																						...
																						while (ocifetch($data_tris_year_criteria))
																							{
																											...
																											if ( $topic_criteria_type_array[$t1] == "2" )
																												{
																													$yr_criteria1 = '<a href="#"  title="ณ สิ้นปี = '.$yr_criteria1_12 .'">'.number_format(ociresult($data_tris_year_criteria,4),2,".",",").'</a>';
																													$yr_criteria2 ='<a href="#"  title="ณ สิ้นปี = '.$yr_criteria2_12 .'">'.number_format(ociresult($data_tris_year_criteria,5),2,".",",").'</a>';
																													$yr_criteria3 = '<a href="#"  title="ณ สิ้นปี = '.$yr_criteria3_12 .'">'.number_format(ociresult($data_tris_year_criteria,6),2,".",",").'</a>';
																													$yr_criteria4 = '<a href="#"  title="ณ สิ้นปี = '.$yr_criteria4_12 .'">'.number_format(ociresult($data_tris_year_criteria,7),2,".",",").'</a>';
																													$yr_criteria5 = '<a href="#" title="ณ สิ้นปี = '.$yr_criteria5_12 .'">'.number_format(ociresult($data_tris_year_criteria,8),2,".",",").'</a>';
																									...
																									// -- สถานะ สีไฟ
																										if ( ($tmpcolor == "N") || ($tmpcolor == "") )

																											{
																													...
																													echo '<img src="images/gray1.gif" width="25" height="25" border="0" align="middle"></td>';
																											}
																										else
																											{
																													...
																													//---  // ถ้าข้อ 1.2  2.1  2.2  ไม่พบ file ที่แนบท้ายข้อ  ให้แสดง สีไฟเป็น สีเทา ด้วย
																													if (  (($topic_code_array[$t1] == "1.2") &&  ($color1_2=="gray")) 
																															|| (($topic_code_array[$t1] == "2.1") &&  ($color2_1=="gray"))	
																														|| (($topic_code_array[$t1] == "2.2") &&  ($color2_2=="gray"))  )
																														{  
																																echo "<td align='center'  valign=".$tb_valign." bgcolor='#6A94F5' style=".$tb_borderstyle.">";
																																echo '<img src="images/gray1.gif" width="25" height="25" border="0" align="middle"></td>';
																														}
																																...
																																switch ($tmpcolor)
																																		{
																																			case ($tmpcolor >= 4): // สีเขียว
																																						echo "<td align='center'  valign=".$tb_valign." bgcolor='#6A94F5' style=".$tb_borderstyle.">";
																																						$file_n3 = "report_sub3.php?mn=".chkmn($mn)."&yr=".$yr."&topicid=".$topic_code_array[$t1]."&criteriatype=".$topic_criteria_type_array[$t1];
																																						echo '<a href="javascript:na_open_window3(\'win\', \''.$file_n3.'\' )" target="_self" title="คลิ๊กเพื่อดูพยากรณ์ผลการดำเนินงานที่คาดว่าจะทำได้ปลายปี ปัญหา/อุปสรรค  เสนอแนวทางแก้ไข ผู้รับผิดชอบ และผู้ประสานงาน '. $file_flag.' "><img src="images/green.gif" width="25" height="25" border="0" align="middle"></a>';
																																						echo "</td>";
																																						break;
																																			case (($tmpcolor >= 3) && ($tmpcolor < 4)): // สีเหลือง
																																					echo "<td align='center'  valign=".$tb_valign." bgcolor='#6A94F5' style=".$tb_borderstyle.">";
																																						$file_n3 = "report_sub3.php?mn=".chkmn($mn)."&yr=".$yr."&topicid=".$topic_code_array[$t1]."&criteriatype=".$topic_criteria_type_array[$t1];
																																						echo '<a href="javascript:na_open_window3(\'win\', \''.$file_n3.'\' )" target="_self" title="คลิ๊กเพื่อดูพยากรณ์ผลการดำเนินงานที่คาดว่าจะทำได้ปลายปี ปัญหา/อุปสรรค  เสนอแนวทางแก้ไข ผู้รับผิดชอบ และผู้ประสานงาน '. $file_flag.' "><img src="images/yellow.gif" width="25" height="25" border="0" align="middle"></a>';
																																						echo "</td>";
																																			...
																																			case ($tmpcolor < 3): // สีแดง
																																						echo "<td align='center'  valign=".$tb_valign." bgcolor='#6A94F5' style=".$tb_borderstyle.">";
																																						$file_n3 = "report_sub3.php?mn=".chkmn($mn)."&yr=".$yr."&topicid=".$topic_code_array[$t1]."&criteriatype=".$topic_criteria_type_array[$t1];
																																						echo '<a href="javascript:na_open_window3(\'win\', \''.$file_n3.'\' )" target="_self" title="คลิ๊กเพื่อดูพยากรณ์ผลการดำเนินงานที่คาดว่าจะทำได้ปลายปี ปัญหา/อุปสรรค  เสนอแนวทางแก้ไข ผู้รับผิดชอบ และผู้ประสานงาน '. $file_flag.' "><img src="images/red.gif" width="25" height="25" border="0" align="middle"></a>';
																																						echo "</td>";
																																						$file_flag  = ""  ;
																									...
																									// -- สถานะ สีไฟ
																										if ( ($tmpcolor == "N") || ($tmpcolor == ""))
																										...
																										else
																											{
																												...
																												$na_fileopentopicid = "search".$dash_topicid.".php?year=".$yr."&month=".$mn;
																	...
																	if ($light >= 4) // สีเขียว
																	...
																	else
																		{
																			if (($light >= 3) && ($light < 4))  // สีเหลือง
																				...
																				{
																					if (($light < 3)&& ($light > 0)) // สีแดง
																						{
																									echo "<td align='center' valign=".$tb_valign." bgcolor='#CCFFFF' style=".$tb_borderstyle.">";
																									echo '<img src="images/red.gif" width="30" height="30" border="0" align="middle">';
																									echo "</td>";
																						}  // end if (($light < 3)&& ($light > 0))
																					else
																						{  // สีเทา
																									echo "<td align='center' valign=".$tb_valign." bgcolor='#CCFFFF' style=".$tb_borderstyle.">";
																									echo '<img src="images/gray1.gif" width="30" height="30" border="0" align="middle">';
																									echo "</td>";
																						} // end else if (($light < 3)&& ($light > 0))

																				}  // end  else if (($light >= 3) && ($light < 4))

																		} // end  else if ($light >= 4) // สีเขียว
...
//---333333333333333333333333 END  แสดงผล  33333333333333333333333333333333333333333333333333
			...
			// ปุ่ม Return
				...
				echo "ไฟสถานะพยากรณ์ปลายปี  หมายถึง : <br>";
				 ...
				 echo '<img src="images/green.gif" width="25" height="25" border="0" > : พยากรณ์คะแนน ณ สิ้นปี ตั้งแต่ระดับคะแนน 4 ขึ้นไป&nbsp;&nbsp;';
				 echo '<img src="images/gray1.gif" width="25" height="25" border="0" > : ยังไม่รายงานผล<br><br>';
