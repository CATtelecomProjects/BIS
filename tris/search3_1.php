...
?>
    ...
    <tr>
        <td width="1000" colspan="3" style="border-width:1; border-color:white; border-style:none;">

            <table border="1" width="995">
                <tr>
                    <td width="500" colspan="2" bgcolor="#0066FF" >
                        <p align="center"><b><font size="2" face="MS Sans Serif" color="#FFFFFF">เกณฑ์วัดผลการดำเนินงาน</font></b><font size="2" face="MS Sans Serif"></font></p>
                    </td>
                    <td width="250"  bgcolor="#0066FF" >
                        <p align="center"><b><font size="2" face="MS Sans Serif" color="#FFFFFF">ความคืบหน้าการดำเนินการ (จากปีที่ผ่านมา)</font></b><font size="2" face="MS Sans Serif"></font></p>
                    </td>
		            <td width="250" bgcolor="#0066FF" >
                        <p align="center"><b><font size="2" face="MS Sans Serif" color="#FFFFFF">ปัญหา/อุปสรรค เสนอแนวทางแก้ไข</font></b></p>
                    </td>
		</tr>
...
<?
		...
		{		
                ...
                OCIExecute($data);
						...
						while ($row = ocifetch($data)) // วนใส่ ทีละ Record
								{																		
										...
										$file = "show_detail.php?solution=".$solution;  //ส่งค่า reason กับ solution ไปแสดงใน popup window
										...
										switch (substr($subtopic_id,0,1))   // แสดง Header
												...
												else
											{
												...
												echo '<tr bgcolor="#CCCC99"><td width="30" valign="top" ><font size="2" face="MS Sans Serif">'.$subtopic_id.'</font></td>';
												echo '<td width="470" valign="top" bgcolor="#FFFFCC"><font size="2" face="MS Sans Serif">'.$subtopic_name.'</font></td>';
												echo '<td width="250" valign="top" bgcolor="#CCFFCC"><font size="2" face="MS Sans Serif">'.$progress.'</font></td>';
												echo '<td width="250" valign="top" bgcolor="#ffddff"> <font size="2" face="MS Sans Serif">'.$solution.' </font> </td></tr>';
											}
			...
			{
					echo '<tr><td width="1000"   colspan="2"  bgcolor="#99CCFF" ><b><font size="2" face="MS Sans Serif">ประเด็นการพิจารณาที่ 1 : บทบาทและการปฏิบัติหน้าที่ของคณะกรรมการ ';
					echo '</font></b><font size="2" face="MS Sans Serif"></font></td>';
					echo '<td width="200" bgcolor="#99CCFF" ><font size="2" face="MS Sans Serif">&nbsp;</font></td>';
					echo '<td width="200" bgcolor="#99CCFF" ><font size="2" face="MS Sans Serif">&nbsp;</font></td></tr>';
					echo '<tr ><td width="1000" colspan="2"  bgcolor="#99CCFF" ><b><font size="2" face="MS Sans Serif">ประเด็นการพิจารณาที่ 2 : การพัฒนาตนเองของคณะกรรมการ ';
					echo '</font></b><font size="2" face="MS Sans Serif"></font></td>';
					echo '<td width="200" bgcolor="#99CCFF" ><font size="2" face="MS Sans Serif">&nbsp;</font></td>';
					echo '<td width="200" bgcolor="#99CCFF" ><font size="2" face="MS Sans Serif">&nbsp;</font></td></tr>';
					echo '<tr><td width="1000" ><b><font size="2" face="MS Sans Serif">';
