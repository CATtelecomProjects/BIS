...
<table border = "0" cellspacing="0" width="1000" bordercolordark="white" bordercolorlight="black" style="border-collapse:collapse;">
    ...
    <tr>
        <td width="996" colspan="3" style="border-width:1; border-color:white; border-style:solid;">
            ...
            <p align="center"><b><font size="2">การประเมินผลการควบคุมภายใน</font></b><font size="2" face="MS Sans Serif"></font></p>
        </td>
    </tr>
    <tr>
...
<?	
	...
	$topic_id = '3.3.1'; //ค่า topic_id = 3.3.1
	$max_year = date("Y")  + 543;	
...
<?
		...
		{		
			...
			$sql = $sql." g.topic_id = '".$topic_id."' and g.year = '".$year."' and  substr(g.subtopic_id,1,1) <> '6'";
			...
			{
					echo '<tr><td width="1000"   colspan="2"  bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><b><font size="2" face="MS Sans Serif">ประเด็นการพิจารณาที่ 1';
					echo '</font></b><font size="2" face="MS Sans Serif"></font></td>';
					...
					echo '<tr><td width="1000" colspan="2"  bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><b><font size="2" face="MS Sans Serif">ประเด็นการพิจารณาที่ 2 ';
					echo '</font></b><font size="2" face="MS Sans Serif"></font></td>';
					echo '<td width="200" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td>';
					echo '<td width="200" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td></tr>';
