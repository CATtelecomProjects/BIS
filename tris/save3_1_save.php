...
// === Start  Select  ข้อมูลก่อนว่ามีอยู่แล้วหรือยัง  จะได้รู้ว่าจะทำการ  Insert into  หรือ  Update 
		...
		$sql_chk_havedata = $sql_chk_havedata." and topic_id = '3.1'";		
		...
		switch ($chk_havedata)
			{
				case "Y":
								...
								// ==== START   Update  
												...
												if (!empty($progress))
													...
													$sql_upd_data = $sql_upd_data." and  topic_id  = '3.1'";
											  ...
											  if ($chk_upd_ok > 0 )
													{
																	// --- Start -- Pop Up ข้อมูลขึ้นมา โดยใช้ javascript
																		...
																		echo '");  ';
																		echo " parent.location = 'save3_1.php?yr=".$yr."&mn=".$mn."&g1=".$g1."'; ";
																		echo '}';
																		echo '</script>';
				...
				case "N";   //  Insert   new  data
								...
								// ==== START   Insert new data
												...
												$sql_ins_data = $sql_ins_data." values('".$yr."','".$mn."','".$g1."','".$topicid."',".$percent_sucess.",".$score_level.",".$reason.",".$solution.",2,'".$emp_id."',sysdate , ".$progress.") ";
