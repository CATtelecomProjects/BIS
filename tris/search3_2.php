...
<table border = "0" cellspacing="0" width="1000" bordercolordark="white" bordercolorlight="black" style="border-collapse:collapse;">
    ...
    <tr>
        <td width="996" colspan="3" style="border-width:1; border-color:white; border-style:solid;">
            ...
            <p align="center"><b><font size="2">การประเมินผลการบริหารความเสี่ยง</font></b><font size="2" face="MS Sans Serif"></font></p>
        </td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
        <td width="1000" colspan="3" style="border-width:1; border-color:white; border-style:solid;">

            <table border="1" width="1000" cellspacing="1">
                <tr>
                    <td width="400" colspan="2" bgcolor="#0066FF" >
...
<?
		...
		{		
                ...
                OCIExecute($data);
						...
						while ($row = ocifetch($data)) // วนใส่ ทีละ Record
								{																		
										...
										switch (substr($subtopic_id,0,1))   //  Header
											{
												case "1" ;
														$header  = "ระดับที่ 1 : การบริหารความเสี่ยงน้อยมาก";														
														break;														
												case "2";
														$header  = "ระดับที่ 2 : การบริหารความเสี่ยงเบื้องต้นที่มีระบบ";
														break;																								
												case "3";												
														$header  = "ระดับที่ 3 : การเชื่อมโยงและบูรณาการความเสี่ยงกับการบริหารเทคโนโลยีสารสนเทศที่ดี";	
														break;
												case "4";												
														$header  = "ระดับที่ 4 : การบริหารความเสี่ยงที่สร้างมูลค่าเพิ่มแก่องค์กร";	
														break;
												case "5";												
														$header  =  "ระดับที่ 5 : การปลูกฝังให้การบริการความเสี่ยงเป็นส่วนหนึ่งของวัฒนธรรมที่นำไปสู่การสร้างสรรค์มูลค่าให้แก่องค์กร";	
														break;
												case "6";												
														$header  = "ระดับที่ 6 : ";	
														break;
											...
											{
													echo '<tr><td width="400" colspan="4" bgcolor="#99CCFF" ><b><font size="2" face="MS Sans Serif">'.$header;
													...
													echo '<td width="370" valign="top" bgcolor="#FFFFCC"><font size="2" face="MS Sans Serif">'.$subtopic_name.'</font></td>';
													echo '<td width="300" valign="top" bgcolor="#CCFFCC"><font size="2" face="MS Sans Serif">'.$progress.'</font></td>';										
													echo '<td width="300" valign="top" bgcolor="#FFDDFF"> <font size="2" face="MS Sans Serif">'.$solution.' </font> </td></tr>';
			...
			{
					echo '<tr><td width="1000" colspan="2" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><b><font size="2" face="MS Sans Serif"> ';
					echo 'ระดับที่ 1 : การบริหารความเสี่ยงน้อยมาก</font></b><font size="2" face="MS Sans Serif"></font></td>';
					...
					echo '<tr><td width=1000" colspan="2" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><b><font size="2" face="MS Sans Serif">';
					echo 'ระดับที่ 2 : การบริหารความเสี่ยงเบื้องต้นที่มีระบบ</font></b><font size="2" face="MS Sans Serif"></font></td>';
					echo '<td width="200" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td>';
					echo '<td width="200" bgcolor="#99CCFF"style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td></tr>';

					echo '<tr><td width="1000" colspan="2" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><b><font size="2" face="MS Sans Serif">';
					echo 'ระดับที่ 3 : การเชื่อมโยงและบูรณาการความเสี่ยงกับการบริหารเทคโนโลยีสารสนเทศที่ดี</font></b><font size="2" face="MS Sans Serif"></font></td>';
					echo '<td width="200" bgcolor="#99CCFF"  style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td>';	
					echo '<td width="200" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td></tr>';
					
					echo '<tr><td width="1000" colspan="2" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><b><font size="2" face="MS Sans Serif">';
					echo 'ระดับที่ 4 : การบริหารความเสี่ยงที่สร้างมูลค่าเพิ่มแก่องค์กร</font></b><font size="2" face="MS Sans Serif"></font></td>';
					echo '<td width="57" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td>';
					echo '<td width="207" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td></tr>';

					echo '<tr><td width="1000" colspan="2" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><b><font size="2" face="MS Sans Serif">';
					echo 'ระดับที่ 5 : การปลูกฝังให้การบริการความเสี่ยงเป็นส่วนหนึ่งของวัฒนธรรมที่นำไปสู่การสร้างสรรค์มูลค่าให้แก่องค์กร</font></b><font size="2" face="MS Sans Serif"></font></td>';
					echo '<td width="200" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td>';
					echo '<td width="200" bgcolor="#99CCFF" style="border-width:1; border-color:black; border-style:solid;"><font size="2" face="MS Sans Serif">&nbsp;</font></td></tr>';
