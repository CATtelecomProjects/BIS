...
# $autoActivate:  Activation type of newly registered users.
#                   false: Requires activation by user (recommended)
...
$user_prefix = "nuke";
$dbtype = "MySQL";
$sitekey = "FxFP2wcTbrBuHzLKlbwfKTvKPnTfUUcUgQgW65Qy";
$gfx_chk = 0;
$subscription_url = "";
$admin_file = "admin";
...
$badreasons = 4;
$AllowableHTML = array("col"=>2,"td"=>2,"tr"=>2,"hr"=>1,"p"=>1,"font"=>2,"embed"=>2,"font color"=>2,"table"=>2,"b"=>1,"i"=>1,"strike"=>1,"div"=>2,"u"=>1,"a"=>2,"em"=>1,"br"=>1,"strong"=>1,"blockquote"=>1,"tt"=>1,"li"=>1,"ol"=>1,"ul"=>1,"img"=>2,"img src="=>2,"center"=>1);
